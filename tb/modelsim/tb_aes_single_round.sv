...
module tb_aes_single_round();
    ...
    initial begin
        ...
        file_data_out = $fopen("../../../tb/common/output_data_AES_single_round/output_data.txt", "w");
        ...
        while (!$feof(file_data_in)) begin
            ...
            if (r > 0) begin
                ...
                if (r != 1) begin
                    $display("Error while reading input data: %s", line_key);
                end
            end

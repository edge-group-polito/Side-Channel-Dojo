...
with open(success_rate_file_S0, "r") as f:
    ...
    plot_success_rate_vs_traces(success_rate_vs_traces_0, sbox_type, resolution)

with open(key_ranks_file_S0, "r") as f:
    key_ranks_0 = json.load(f)
    plot_key_rank_vs_traces(key_ranks_0, 11, sbox_type, resolution) # Example for key bit index 11


# Load data for S1 and plot
with open(success_rate_file_S1, "r") as f:
    success_rate_vs_traces_1 = json.load(f)
    plot_success_rate_vs_traces(success_rate_vs_traces_1, sbox_type, resolution)

with open(key_ranks_file_S1, "r") as f:
    key_ranks_1 = json.load(f)
    plot_key_rank_vs_traces(key_ranks_1, 46, sbox_type, resolution) # Example for key bit index 46

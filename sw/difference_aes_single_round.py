...
for i in range(0,9):
    ...
    file_name_questa = "../tb/common/output_data_AES_single_round/output_data_" + sbox_type[i] + ".txt"

    k = 1
    with open(file_name_py, "r") as python_file:
        with open(file_name_questa, "r") as questa_file:
            with open("simulation_results_aes_single_round.txt", 'w') as output_file:

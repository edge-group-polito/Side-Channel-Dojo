...
SNR_OUT_FILE = CACHE_DIR / f"snr_ranked_{analysis_name}_{snr_trace_count_tag}.h5"
SNR_TRACE_OUT_FILE = CACHE_DIR / f"snr_traces_{analysis_name}_{snr_trace_count_tag}.h5"
...
try:
    ...
    raise SystemExit(
        ...
        "Please check traceset_size_k, trace_sbox_type, and TRACESET_DIR."
    )
except Exception as e:
...
if save_snr_ranked_all_bits:
    with h5py.File(SNR_OUT_FILE, "w") as f:
        f.attrs["sbox_type"] = analysis_name

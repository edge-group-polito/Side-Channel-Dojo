...
module aes_ks (
  ...
  localparam [2:0] KEYSCHED_TYPE_1 = 0;
  localparam [2:0] KEYSCHED_TYPE_2 = 1;
  localparam [2:0] KEYSCHED_TYPE_3 = 2;
  localparam [2:0] KEYSCHED_TYPE_A = 3;
  localparam [2:0] KEYSCHED_TYPE_B = 4;
  localparam [2:0] KEYSCHED_TYPE_C = 5;
...
`ifdef SBOX_COMB
  ks_sub_layer_hw ks_sub_layer_inst(
    .state_i (w0_sub_i[31:0]),
    .state_o (w0_sub_o[31:0])
  );
  `else // SBOX_LUT
    ks_sub_layer_lut ks_sub_layer_inst(
      .state_i (w0_sub_i[31:0]),
      .state_o (w0_sub_o[31:0])
    );
  `endif
